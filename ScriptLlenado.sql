...
EXEC SP_Insertar_Profesor '13','1234','f4gfjniglk5g36f45jg3','Drive','3g6ty=3d456','Ada','Lovelace','Ada@gmail.com',27658127,'11/15/2016','Lunes y Miercoles 9:30 a 12:30','Costa Rica','San Jose'
EXEC SP_Insertar_Profesor '14', '1234','x54345yul3g6ty3d4563','Drive','3thrj=4564a','Blaise','Pascal','Blaise@gmail.com',22935176,'11/15/2016','Martes y Jueves 7:30 a 9:30','Costa Rica','San Jose'
EXEC SP_Insertar_Profesor '15','1234','97u8lo74il853tx586h7','Drive','6r8g3=4arg8','Carl','Sagan','Carl@gmail.com',26250687,'11/15/2016','Miercoles y Viernes 13:00 a 15:00','Costa Rica','San Jose'
EXEC SP_Insertar_Profesor '16','1234','s35h7ga863f4gfjniglk','Drive','63a74=rgarg','Heinrich','Hertz','Heinrich@gmail.com',22506892,'11/15/2016','Miercoles y Viernes 13:00 a 15:00','Costa Rica','San Jose'
EXEC SP_Insertar_Profesor '17','1234','5g36f45jg3x54345yul3','Drive','38a4g=r8a4r','Gottfried','Leibniz','Gottfried@gmail.com',24565424,'11/15/2016','Lunes y Miercoles 9:30 a 12:30','Costa Rica','San Jose'
EXEC SP_Insertar_Profesor '18','1234','g6ty3d4563thrj456d3k','Drive','3g8a7=r4g8a','Beatrix','Potter','Beatrix@gmail.com',25560462,'11/15/2016','Miercoles y Viernes 13:00 a 15:00','Costa Rica','San Jose'
EXEC SP_Insertar_Profesor '19','1234','853tx586h7s35h7ga863','Drive','3x543=45yul','Edwin','Hubble','Edwin@gmail.com',27946215,'11/15/2016','Martes y Jueves 7:30 a 9:30','Costa Rica','Heredia'
