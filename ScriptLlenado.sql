...
EXEC SP_Insertar_Empresa '23','1234','8a7rega87hh36a47812a','Drive','7ga86=3f4gf','Leonard','Euler','Stygies Ocho','Stygies8@gmail.com',25173952,'http://warhammer40k.wikia.com/wiki/Stygies_VIII','Costa Rica','San Jose','Stygies8'		EXEC SP_Insertar_Empresa '24','1234','6gr788ilo34kghj83gh7','Drive','niglk=5g36f','Michael','Faraday','Graia','Graia13@gmail.com',21761576,'http://warhammer40k.wikia.com/wiki/Graia','Costa Rica','Heredia','Graia13'				
...
EXEC SP_Insertar_Curso '14', 'Bases De Datos', 'CE-4101', '1', 68
EXEC SP_Insertar_Curso '14', 'Matemática General', 'CE-4101', '1', 68
EXEC SP_Insertar_Curso '15', 'Introducción a la Física', 'CE-4101', '1', 68
EXEC SP_Insertar_Curso '16', 'Estructuras de Datos 2', 'CE-4101', '1', 68
...
EXEC SP_Insertar_Badge 'Patrones de Diseño', '25', '1'
	...
	/*Bases De Datos*/
EXEC SP_Insertar_Badge 'SQL Server', '50', '1'
EXEC SP_Insertar_Badge 'Diagramas de Diseño', '25', '1'
EXEC SP_Insertar_Badge 'C#', '25', '1'

	/*Matemática General*/
EXEC SP_Insertar_Badge 'Sumas', '25', '1'
EXEC SP_Insertar_Badge 'Restas', '25', '1'
EXEC SP_Insertar_Badge 'Geometría', '25', '1'
EXEC SP_Insertar_Badge 'Lógica', '25', '1'

	/*Introducción a la Física*/
EXEC SP_Insertar_Badge 'Escalares', '5', '1'
EXEC SP_Insertar_Badge 'Vectores', '10', '1'
EXEC SP_Insertar_Badge 'Movimiento', '15', '1'
EXEC SP_Insertar_Badge 'Fuerza', '20', '1'
EXEC SP_Insertar_Badge 'Energía', '25', '1'
EXEC SP_Insertar_Badge 'Torque y Rotación', '25', '1'

	/*Estructuras de Datos 2*/
EXEC SP_Insertar_Badge 'Listas', '25', '1'
EXEC SP_Insertar_Badge 'Matrices', '25', '1'
EXEC SP_Insertar_Badge 'Grafos', '25', '1'
EXEC SP_Insertar_Badge 'Arboles', '25', '1'
...
EXEC SP_Insertar_Propuesta_Proyecto '3', 'Full justification', 'la preferencia de justificar el texto de manera correcta', 'un sistema que ayuda a dar formato a lectores de libros electrónicos con justificación separada por guines en vez de separacaión por espacios en blanco', '1', '10/18/2016', '11/30/2016', ''
EXEC SP_Asignar_Tecnologia_Proyecto '3', '6'
EXEC SP_Asignar_Tecnologia_Proyecto '3', '15'
EXEC SP_Asignar_Tecnologia_Proyecto '3', '18'
EXEC SP_Insertar_Propuesta_Proyecto '4', 'Shredder', 'Sistema para un servicio de reciclaje de papel', 'Una máquina necesita una actualización de interfaz y lógica que mejore la eficiencia de la empresa en un 70%', '1', '10/18/2016', '11/30/2016', ''
EXEC SP_Asignar_Tecnologia_Proyecto '3', '13'
EXEC SP_Asignar_Tecnologia_Proyecto '3', '16'
EXEC SP_Asignar_Tecnologia_Proyecto '3', '19'

	/*Aceptar proyectos - puntos extra*/
EXEC SP_Aceptar_Proyecto '1', '1', '1'

	/*Otorgar badges*/
EXEC SP_Otorgar_Badge '1', '1'

	/*Insertar Trabajos y tecnologías*/
