...
CREATE PROCEDURE SP_MyEmployee_Custom @Top INT, @PorcentajeNotas FLOAT, @PorcentajeEstrellas FLOAT, @Proyectos FLOAT, @Trabajos FLOAT, @Minimo INT
	AS
		...
		WHERE CAST(NotaPromedio*@PorcentajeNotas+PromedioEstrellas*@PorcentajeEstrellas+
				(ProyectosExitosos*100/ProyectosTerminados)*@Proyectos+
				(CursosExitosos*100/CursosTerminados)*@Trabajos AS FLOAT) >= @Minimo
