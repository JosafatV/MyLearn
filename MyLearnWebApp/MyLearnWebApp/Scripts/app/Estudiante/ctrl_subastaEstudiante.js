    ...
    function (srcv_cerrarSesion,$q, $scope, $routeParams, $location, ModalService, fct_MyLearn_API_Client, twitterService, uibModal) {
        ...
        */
        ...
        $scope.get_subastas = function () {
            fct_MyLearn_API_Client.query({ type: 'Subastas', extension1: $scope.str_tecnologia.Id, extension2:'Nombre', extension3: $routeParams.IdUser }).$promise.then(function (data) {
