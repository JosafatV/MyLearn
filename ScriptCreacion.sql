...
CREATE TABLE USUARIO (
	...
	NombreDeUsuario CHAR(40) NOT NULL UNIQUE,
	Estado CHAR(1),
...
CREATE TABLE DriveCredentials (
	 ...
	 RefreshToken VARCHAR(500),
	  ...
	  CONSTRAINT PK_DRIVE_CREDENTIALS
		PRIMARY KEY (UserId),
      CONSTRAINT FK_DRIVE_CREDENTIALS
...
CREATE TABLE TWITTER_CREDENTIALS (
	 UserId CHAR(100),
	 AccessToken VARCHAR(500),
	 AccessTokenSecret VARCHAR(500),

	  CONSTRAINT PK_TWITTER_CREDENTIALS
		PRIMARY KEY (UserId),
      CONSTRAINT FK_TWITTER_CREDENTIALS
		FOREIGN KEY (UserId) REFERENCES USUARIO(Id)
);
...
CREATE TABLE ESTUDIANTE (
    ...
    CONSTRAINT FK_ESTUDIANTE_ID
		FOREIGN KEY (Id) REFERENCES USUARIO(Id),
	CONSTRAINT FK_ESTUDIANTE_PAIS
		FOREIGN KEY (Pais) REFERENCES PAIS(Pais),
	CONSTRAINT FK_ESTUDIANTE_UNIVERSIDAD
...
ALTER TABLE TRABAJO ADD Exitoso BIT NULL
/**/
...
CREATE TABLE TECNOLOGIA_POR_ESTUDIANTE
(
    IdTecnologia INT,
    IdEstudiante CHAR(100),
	Estado CHAR(1),

	CONSTRAINT PK_TECNOLOGIA_POR_ESTUDIANTE
		PRIMARY KEY (IdTecnologia,IdEstudiante),
	CONSTRAINT FK_IDTECNOLOGIA_POR_ESTUDIANTE
		FOREIGN KEY (IdTecnologia) REFERENCES TECNOLOGIA (Id),
	CONSTRAINT FK_IDESTUDIANTE_TECNOLOGIA_POR_ESTUDIANTE
		FOREIGN KEY (IdEstudiante) REFERENCES ESTUDIANTE(Id)
);
...
CREATE TABLE USUARIO_MYEMPLOYEE (
    Id INT IDENTITY(1,1),
	NombreUsuario CHAR(60) UNIQUE NOT NULL, 
    Contrasena CHAR(8) NOT NULL,
	Sal CHAR(20),
	Estado CHAR(1),

    CONSTRAINT PK_USUARIO_MYEMPLOYEE
		PRIMARY KEY (Id),
);